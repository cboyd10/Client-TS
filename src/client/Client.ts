...
export class Client extends GameShell {
    ...
    private buildXpTrackerCards(): XpTrackerCardData[] {
        ...
        return order.map((stat: number): XpTrackerCardData => {
            ...
            if (elapsedMs < 5000) {
                return {skillId: stat, skillName, calculating: true, xpGained: gained, xpPerHour: 0, xpLeft: 0, baseLevel, percentToLevel: 0, secondsToLevel: 0, targetLevel};
            }
            ...
            return {skillId: stat, skillName, calculating: false, xpGained: gained, xpPerHour, xpLeft, baseLevel, percentToLevel, secondsToLevel, targetLevel};
        });
    }
