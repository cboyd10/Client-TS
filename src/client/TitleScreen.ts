...
export default class TitleScreen {
    ...
    static readonly AUTO_CHARLIST: string = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| ';
    static readonly charList: string = TitleScreen.AUTO_CHARLIST;
